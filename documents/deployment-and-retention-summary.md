...
| 数据表 | 保留期限 | 说明 |
|--------|----------|------|
| `t_access_log` | 30天 | 访问日志，用于运维排查 |
| `t_error_log` | 90天 | 错误日志，用于问题追踪 |
| `t_search_history` | 30天 | 搜索历史，用于搜索优化 |
| `t_mp_browse_history` | 30天 | 小程序浏览历史 |
| `t_mp_reco_exposure` | 30天 | 推荐曝光记录 |
| `t_statistics_article_pv` | 365天 | 文章 PV 统计 |
